    ...
    <div>
      <Menu as='div' className='inline-block text-left'>
        <div className='flex'>
          ...
          rounded-md bg-white md:px-4 py 2 text-sm 
          font-medium text-slate-700 hover:bg-opacity-20'>
            <div className="leading[80px] flex flex-col
            items-start">
        ...
        >
          ...
          dividfe-gray-100 rounded-md bg-white shadow-lg 
          focus:outline-none '>
             <div className='p-1 '>
              <Menu.Item>
                {({ active }) => (
                  <Link
                    to={`${
                      user?.accountType ? "seeker-profile" : "lister-profile"
                    }`}
                    className={`${
