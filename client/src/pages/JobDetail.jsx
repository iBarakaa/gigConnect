            ...
            {selected === "0" ? (
              ...
              <>
                <div className='mb-6 flex flex-col'>
                  ...
                  <span className='text-base'>{job?.lister?.location}</span>
                  <span className='text-sm'>{job?.lister?.email}</span>
                </div>

                <p className='text-xl font-semibold'>About Lister</p>
                <span>{job?.lister?.about}</span>
              </>
            )}
          </div>
